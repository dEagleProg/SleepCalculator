...
const SleepTips = () => {
  ...
  return (
    <>
      <SEOHead
        title="Sleep Tips - Improve Your Sleep Quality"
        description="Discover effective tips and recommendations for better sleep. Science-backed methods to improve your sleep quality and establish healthy sleep habits."
        keywords="sleep tips, sleep improvement, sleep hygiene, sleep quality, sleep habits, insomnia, sleep disorders, better sleep, sleep routine, sleep schedule"
      />
